...
MTypeId shVizNode::id( 0x0003507 );
MObject shVizNode::atype;
MObject shVizNode::alight0x;
MObject shVizNode::alight0y;
MObject shVizNode::alight0z;
MObject shVizNode::alight1x;
MObject shVizNode::alight1y;
MObject shVizNode::alight1z;
MObject shVizNode::alight2x;
MObject shVizNode::alight2y;
MObject shVizNode::alight2z;
MObject shVizNode::aoutput;

shVizNode::shVizNode():m_sh(0),m_type(0)
{
...
MStatus shVizNode::compute( const MPlug& plug, MDataBlock& data )
{ 
	MStatus status;
	if(plug == aoutput)
	{
...
void shVizNode::draw( M3dView & view, const MDagPath & /*path*/, 
...
bool shVizNode::isBounded() const
{ 
	return false;
}

MBoundingBox shVizNode::boundingBox() const
{ 
...
void* shVizNode::creator()
{
	return new shVizNode();
}

MStatus shVizNode::initialize()
{ 
	MStatus			 status;
