...
struct MATRIX44F
{
	...
	MATRIX44F(const float mat[4][4])
	{
		v[0][0] = mat[0][0]; v[0][1] = mat[0][1]; v[0][2] = mat[0][2]; v[0][3] = mat[0][3];
		v[1][0] = mat[1][0]; v[1][1] = mat[1][1]; v[1][2] = mat[1][2]; v[0][3] = mat[1][3];
		v[2][0] = mat[2][0]; v[2][1] = mat[2][1]; v[2][2] = mat[2][2]; v[2][3] = mat[2][3];
		v[3][0] = mat[3][0]; v[3][1] = mat[3][1]; v[3][2] = mat[3][2]; v[3][3] = mat[3][3];
	}
