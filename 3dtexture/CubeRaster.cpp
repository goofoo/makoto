...
void CubeRaster::write2(XYZ& ray, float val)
{
	...
	if(nu0 > -1 && nu0 < CUBERASTER_BUFFER2_N && nv0 > -1 && nv0 < CUBERASTER_BUFFER2_N) fOpacity2[offset + nv0*CUBERASTER_BUFFER2_N + nu0] += val;
	if(nu1 > -1 && nu1 < CUBERASTER_BUFFER2_N && nv0 > -1 && nv0 < CUBERASTER_BUFFER2_N) fOpacity2[offset + nv0*CUBERASTER_BUFFER2_N + nu1] += val;
	if(nu1 > -1 && nu1 < CUBERASTER_BUFFER2_N && nv1 > -1 && nv1 < CUBERASTER_BUFFER2_N) fOpacity2[offset + nv1*CUBERASTER_BUFFER2_N + nu1] += val;		
	if(nu0 > -1 && nu0 < CUBERASTER_BUFFER2_N && nv1 > -1 && nv1 < CUBERASTER_BUFFER2_N) fOpacity2[offset + nv1*CUBERASTER_BUFFER2_N + nu0] += val;
}
...
void CubeRaster::write4(XYZ& ray, float val)
{
	...
	if(nu0 > -1 && nu0 < CUBERASTER_BUFFER4_N && nv0 > -1 && nv0 < CUBERASTER_BUFFER4_N) fOpacity4[offset + nv0*CUBERASTER_BUFFER4_N + nu0] += val;
	if(nu1 > -1 && nu1 < CUBERASTER_BUFFER4_N && nv0 > -1 && nv0 < CUBERASTER_BUFFER4_N) fOpacity4[offset + nv0*CUBERASTER_BUFFER4_N + nu1] += val;
	if(nu1 > -1 && nu1 < CUBERASTER_BUFFER4_N && nv1 > -1 && nv1 < CUBERASTER_BUFFER4_N) fOpacity4[offset + nv1*CUBERASTER_BUFFER4_N + nu1] += val;		
	if(nu0 > -1 && nu0 < CUBERASTER_BUFFER4_N && nv1 > -1 && nv1 < CUBERASTER_BUFFER4_N) fOpacity4[offset + nv1*CUBERASTER_BUFFER4_N + nu0] += val;
}
...
void CubeRaster::write8(XYZ& ray, float val)
{
	...
	if(nu0 > -1 && nu0 < CUBERASTER_BUFFER8_N && nv0 > -1 && nv0 < CUBERASTER_BUFFER8_N) fOpacity8[offset + nv0*CUBERASTER_BUFFER8_N + nu0] += val;
	if(nu1 > -1 && nu1 < CUBERASTER_BUFFER8_N && nv0 > -1 && nv0 < CUBERASTER_BUFFER8_N) fOpacity8[offset + nv0*CUBERASTER_BUFFER8_N + nu1] += val;
	if(nu1 > -1 && nu1 < CUBERASTER_BUFFER8_N && nv1 > -1 && nv1 < CUBERASTER_BUFFER8_N) fOpacity8[offset + nv1*CUBERASTER_BUFFER8_N + nu1] += val;		
	if(nu0 > -1 && nu0 < CUBERASTER_BUFFER8_N && nv1 > -1 && nv1 < CUBERASTER_BUFFER8_N) fOpacity8[offset + nv1*CUBERASTER_BUFFER8_N + nu0] += val;
}
